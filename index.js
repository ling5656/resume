...
var desH = 960;
//总长度
num.innerHTML = "1/" + oLis.length;
loading.style.width = (1 / oLis.length) * 100 + "%";
...
function move(e) {
    ...
    if (changePos > 0) {/*↓*/
        ...
        num.innerHTML = (this.preSIndex + 1) + "/" + oLis.length;
        loading.style.width = ((this.preSIndex + 1) / oLis.length) * 100 + "%";
